...
server <- function(input, output, session) {
  ...
  # Reactive expression to parse user input for additional heatmap genes
  ...
  heatmap_matrix_reactive <- reactive({
    ...
    selected_genes <- c("IFIT1", "IFIT1B", "IFIT3", "IL7R", "OASL", "SKAP1", "DHX58", "CXCL11", "DDX58", "GBP4", "ZBTB32",
                        "VSTM1", "OAS2", "CCL5", "RTP4", "EBLN1", "MRC1", "BTK", "VAV1", "TNFSF10",
                        "RUFY4", "CCL3L3", "LILRA2", "AIM2", "CTSE", "hpv18E6", "hpv18E7")
  ...
  output$boxplot_gene_selector <- renderUI({
    ...
    selected_genes <- c("IL7R", "OASL", "SKAP1", "DHX58", "CXCL11", "IFIT3", "DDX58", "GBP4", "ZBTB32",
                        "VSTM1", "OAS2", "CCL5", "IFIT1", "RTP4", "VAV1", "TNFSF10", "EBLN1", "IFIT1B",
                        "RUFY4", "MRC1", "BTK", "CCL3L3", "LILRA2", "AIM2", "CTSE", "hpv18E6", "hpv18E7")
